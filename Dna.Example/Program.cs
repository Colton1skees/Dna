...
if (dbgCode)
{
    ...
    */
    ...
    var existingFunc = tempNewMod.GetFunctions().Single(x => x.Name.Contains("Par"));
...
if (useVmp)
{
    ...
    vmpPath = @"C:\Users\user\Downloads\BEClient2_020924_2.dll";
    vmpAddr = 0x180002120;

    //vmpAddr = 0x1401311d2;


    vmpPath = @"C:\Users\user\Downloads\DNA ASSETS\vmptest.vmp.bin";
    vmpAddr = 0x140001030;
