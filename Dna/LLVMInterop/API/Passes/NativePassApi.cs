...
namespace Dna.LLVMInterop
{
    public static class NativePassApi
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public unsafe delegate bool dgCombinedFixedpointPass(LLVMOpaqueValue* function, nint loopInfo, nint domTree, nint mssa, nint simplifyQuery);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public unsafe delegate bool dgAdhocInstCombinePass(LLVMOpaqueValue* function, nint loopInfo, nint domTree, nint mssa, nint simplifyQuery);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public unsafe delegate bool dgMultiUseCloningPass(LLVMOpaqueValue* function, nint loopInfo, nint domTree, nint mssa, nint simplifyQuery);
