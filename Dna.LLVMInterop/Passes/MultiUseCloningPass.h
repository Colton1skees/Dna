...
namespace Dna::Passes {
	struct MultiUseCloningPass : public llvm::PassInfoMixin<MultiUseCloningPass>
	{
		static char ID;

		tEliminateStackVars structureFunction;

		explicit MultiUseCloningPass(tEliminateStackVars structureFunction)
		{
			this->structureFunction = structureFunction;
		}

		explicit MultiUseCloningPass()
		{
